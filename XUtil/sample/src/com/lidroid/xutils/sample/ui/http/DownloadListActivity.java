package com.lidroid.xutils.sample.ui.http;
...
import com.lidroid.xutils.sample.R.id;
import com.lidroid.xutils.sample.R.layout;
import com.lidroid.xutils.sample.R.string;
import com.lidroid.xutils.sample.common.download.DownloadInfo;
import com.lidroid.xutils.sample.common.download.DownloadManager;
import com.lidroid.xutils.sample.common.download.DownloadService;
...
public class DownloadListActivity extends Activity {
	...
	private class DownloadListAdapter extends BaseAdapter {
		...
		public View getView(int i, View view, ViewGroup viewGroup) {
			...
			/**
			 * 1. 从downloadManager中获取DownloadInfo
			 * 2. 从DownloadInfo中获取HttpHandler 3. 从HttpHandler中获取RequestCallBack
			 * 注：DownloadInfo就像是一个全局变量，用来存储下载相关变量，尤其是下载动态RequestCallBack
			 */
			...
			if (handler != null) {
				...
				/*
				 *  UserTag参数用于用户扩展，没有具体的含义
				 *  这里把holder传进去，就相当于把view的集合传了进去，用户设置view
				 */
